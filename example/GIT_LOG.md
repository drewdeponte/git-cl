...
The following are example commits from a test repository. When `git-cl full` is run against these commits it produces the following example [Markdown Changelog Output](https://github.com/uptech/git-changelog/blob/master/example/CHANGELOG.md).
